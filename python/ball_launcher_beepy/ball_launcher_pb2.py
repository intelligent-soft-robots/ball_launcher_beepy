...
_REQUEST_REQUESTTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="SET_STATE", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="LAUNCH_BALL", index=1, number=1, serialized_options=None, type=None
        ),
    ],
...
_REQUEST_STATE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="phi",
            full_name="ball_launcher.Request.State.phi",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="theta",
            full_name="ball_launcher.Request.State.theta",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="top_left_motor",
            full_name="ball_launcher.Request.State.top_left_motor",
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="top_right_motor",
            full_name="ball_launcher.Request.State.top_right_motor",
            index=3,
            number=4,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="bottom_motor",
            full_name="ball_launcher.Request.State.bottom_motor",
            index=4,
            number=5,
            type=2,
            cpp_type=6,
...
_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="request",
            full_name="ball_launcher.Request.request",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
